  ...
  return (
    ...
    >
      ...
      {components.map((comp) => {
        ...
        // VMC (2D or 3D) has a UDP connection dot; VMC and MediaPipe both have
        // a tracking dot (MediaPipe is browser-driven, so it has no connection
        // concept).
        const hasConnection =
