...
import type { InputsOf, OutputsOf, NodeExecutionContext, Blendshapes, Event } from '@vspark/shared/signal'
...
@SignalNode({
  ...
  description: 'Scales all incoming viseme weights by a sensitivity multiplier. Clamped to [0, 1].',
  tags:        ['lipsync'],
  color:       '#4a7a5a',
})
