...
@SignalNode({
  ...
  description: 'Starts playback of a track clip on the configured scene when triggered.',
  tags:        ['output'],
  color:       '#3a5a7a',
})
export class TrackClipTrigger {
  ...
  static execute(
    ...
    if (ctx.triggeredPort !== 'fire') return {} as OutputsOf<typeof TrackClipTrigger>
