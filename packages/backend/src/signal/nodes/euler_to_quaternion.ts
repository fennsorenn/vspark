...
@SignalNode({
  ...
  description: 'Converts pitch/yaw/roll angles (radians) to a unit quaternion using ZYX intrinsic convention. Connect per-axis sine waves to drive procedural rotations.',
  tags:        ['math'],
  color:       '#4a7a5a',
})
