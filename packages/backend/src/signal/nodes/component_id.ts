...
export interface ComponentIdConfig { componentId: string }
...
export class ComponentId {
  ...
  static execute(_: Record<string, never>, config: ComponentIdConfig, _ctx: NodeExecutionContext): OutputsOf<typeof ComponentId> {
