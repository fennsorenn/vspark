...
export class OverliveAdStart {
  ...
  static execute(
    ...
    return handleOverliveEvent<AdStartEvent, { durationSeconds: number; isAutomatic: boolean }>(
      inputs,
      ctx,
      (e) => ({ durationSeconds: e.data.durationSeconds, isAutomatic: e.data.isAutomatic }),
